...
<head>
    ...
    <title> Nibu Thomas | Home :: Personal Resume  </title>
...
<body>
    <div style="position:fixed; color: burlywood; font-weight:00; font-family:Cambria, Cochin, Georgia, Times, Times New Roman, serif; font-style:oblique;" >
        <img src="images/we.jpg" width="80px" style="background-color:white">
        <script>
...
document.write("Vistors :"+ localStorage.pagecount );</script>
    </div>
    <!-- Header -->
    <div class="banner-agile">
        ...
        <div class="container">
            <div class="banner-info-w3l">
                <h3><b>Make A Diffrence</b> </h3>
                <p class="headingname"> <h2> Hi,I am Nibu Thomas</h2></p>
                    ...
                    <div class="agile-about-right-img">
                        ...
                        <b>
                            ...
                            <p style="color:darkblue" >
                                ...
                                I love my freedom of speech and the way my eyes get dark when I'm tired. I love that I have learned to trust people with my heart,
                                even if it will get broken. I am proud of everything that I am and will become."
                ...
                <div class="col-md-7 w3ls-agile-left">
                    <div class="w3ls-agile-left-info">
                        <div class="wel-left animated wow fadeInLeft" data-wow-delay=".5s">
                            ...
                            <div class="text-w3l">
                                ...
                                <p>•Perform code reviews and provide necessary corrections.</p>
                                <p>
                    ...
                    <div class="w3ls-agile-left-info">
                        <div class="wel-left animated wow fadeInLeft" data-wow-delay=".5s">
                            ...
                            <div class="text-w3l">
                                ...
                                <p>  •Modification of existing software to improve its performance</p>
                                <p>
                    ...
                    <div class="w3ls-agile-left-info">
                        <div class="wel-left animated wow fadeInLeft" data-wow-delay=".5s">
                            ...
                            <div class="text-w3l">
                                <h4> <b>BACK END DEVELOPER</b></h4>
                                <p>•Writing the stored procedures and Functions.</p>
                            </div>
                            <div class="clearfix"> </div>
                        </div>
                    </div>
                    <div class="w3ls-agile-left-info">
                        <div class="wel-left animated wow fadeInLeft" data-wow-delay=".5s">
                            ...
                            <div class="text-w3l">
                                ...
                                <p>•There are three responses to a piece of design – <b style="color:greenyellow">yes, no</b>, and <b style="color:greenyellow"> WOW!</b> Wow is the one to aim for</p>
        ...
        <div class="container-fluid">
            ...
            <div class="wthreeskills-grids">
                <div class="col-md-6 wthreeskills-grid wthreeskills-grid-2">
                    ...
                    <div class="bar_group">
                        <div class='bar_group__bar thin' label='C#.Net' show_values='true' tooltip='true' value='75'></div>
                        <div class='bar_group__bar thin' label='MVC' show_values='true' tooltip='true' value='65'></div>
                        <div class='bar_group__bar thin' label='HTML' show_values='true' tooltip='true' value='95'></div>
                        <div class='bar_group__bar thin' label='JAVA SCRIPT' show_values='true' tooltip='true' value='70'></div>
                        <div class='bar_group__bar thin' label='MS SQL' show_values='true' tooltip='true' value='76'></div>
                    </div>
                        ...
                        <div class="sap_tabs">
                            <div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
                                <ul class="resp-tabs-list">
                                    <li class="resp-tab-item"><span>Soft Skills</span></li>
                                    <li class="resp-tab-item"><span>Adaptive Skills</span></li>
                                    <li class="resp-tab-item"><span>SMART WORKER</span></li>
                                </ul>
                                ...
                                <div class="resp-tabs-container">
                                    ...
                                    <div class="tab-3 resp-tab-content">
                                        ...
                                        <div class="w3lsstatsaits-info">
                                            ...
                                            <div class="col-md-4 w3lsstatsaits-grid w3lsstatsaits-grid-3">
                                                <div class="w3lsstatsaitsstats counter" data-slno='1' data-min='0' data-max='12000' data-delay='.5' data-increment="11">9400</div>
                                                <p>Decision Making</p>
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
            ...
            <div class="services-w3ls-row">
                <div class="col-md-3 services-grids">
                    <div class="w3agile-servs-img">
                        ...
                        <p class="description">Cricket, Football, Volleyball</p>
                    </div>
                </div>
                <div class="col-md-3 services-grids">
                    <div class="w3agile-servs-img">
                        ...
                        <p class="description">Learn New Things</p>
                    </div>
                </div>
                <div class="col-md-3 services-grids">
                    <div class="w3agile-servs-img">
                        ...
                        <p class="description">Creativity</p>
                    </div>
                </div>
                <div class="col-md-3 services-grids">
                    <div class="w3agile-servs-img">
                                ...
                                <div class="work">
                                    <div class="work-info">
                                        ...
                                        <div class="col-md-6 work-grid work-right">
                                            <h5><a href="www.ktsinfotech.com"> KTS INFOTECH Pvt Ltd</a> PALAI</h5>
                                            <p>Experience Period: 8 months</p><p> exp. in:  Asp.Net,SQL server,C#,MySql</p><p>  Role: Junior Software Developer</p>
                                        </div>
                                        <div class="clearfix"> </div>
                                    </div>
                                    <div class="work-info">
                                        ...
                                        <div class="col-md-6 work-grid work-left work-left2">
                                            <h5><a href="www.netgainstechnologies.com">NetGains Technologies Pvt Ltd</a> Goregeon, Mumbai</h5>
                                            <p> Currently working as a .NET Developer. Engaged in developing  Cross Platform Applications in  <a href="www.netgainstechnologies.com">NetGains Pvt Technologies</a>, Mumbai </p>
                                        </div>
                                        <div class="clearfix"> </div>
                                    </div>
                                    F
                                ...
                                <div class="work">
                                    ...
                                    <div class="work-info">
                                        ...
                                        <div class="col-md-6 work-grid work-right">
                                            ...
                                            <b><p><asp:label ID="edu1" Text="MCA" runat="server" ForeColor="SteelBlue" Font-Size="Large"></asp:label></p></b>
                                            <p>St.Joseph College of Engineering & Technology Palai </p>
                                        </div>
                                        <div class="clearfix"> </div>
                                    </div>
                                    <div class="work-info">
                                        ...
                                        <div class="col-md-6 work-grid work-left work-left2">
                                            <h5>Graduate</h5>
                                            <p><asp:Label ID="edu2" runat="server" Text="BCA" Font-Bold="true" Font-Size="Large" ForeColor="Violet"></asp:Label></p>
                ...
                <div class="filtr-container">
                    <div class="col-md-3 filtr-item" data-category="1, 4" data-sort="Busy streets">
                        <div class="agileits-img">
                            <a href="images/g55.jpg" class="swipebox" title="MCA Main Project">
                                <img src="images/g5.jpg" alt="" class="img-responsive img-style row2" />
                            </a>
                        </div>
                        <div class="agileits-img">
                            <a href="images/g33.jpg" class="swipebox" title="BCA Main Project">
    ...
    <div class="contact" id="contact">
        ...
        <div class="contact-agile">
            ...
            <div class="contact-left-agile">
                <h4>About Me</h4>
                <p style="color:gold"><b>"I have no special talent. I am only passionately curious."</b></p>
                <p><a href="www.facebook.com/mr.nibuthomas">Nibu Thomas</a></p>
                <div class="add-w3ls-main">
                    <span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span>
                    <div class="add-w3ls2">
                        <h5>Location</h5>
                        <p>
                            704, A Wing, Hiral Green Apartment
                            Sidhivinayaknagar, Near Royal College
                            Mira Road East, Thane, Mumbai
                            401107
                        </p>
                    </div>
                    <div class="clearfix"> </div>
                ...
                <div class="add-w3ls-main">
                    ...
                    <div class="add-w3ls2">
                        <h5>Email</h5>
                        <p><b>Personal: </b><a href="mailto:mr.nibuthomas@gmail.com">mr.nibuthomas@gmail.com.com</a></p>
                        <p><b>Work: </b><a href="mailto:nibu.t@netgainstechnologies.com">nibu.t@netgainstechnologies.com</a></p>
                    </div>
                    <div class="clearfix"> </div>
                </div>
                <div class="add-w3ls-main">
                ...
                <div class="add-w3ls-main">
                    <div class="add-w3ls2">
                        <p>
                            ...
                            <a href="www.facebook.com / mr.nibuthomas"><img src="images/fb.png" width="25px" /></a>
                            <a href="www.twitter.com/@mrnibuthomas"><img src="images/twiteer.png" width="25px" /></a>
                            <a href="www.linkedin.com/in/nibu-thomas-0880b487"><img src="images/linked.png" width="25px" /></a>
    ...
    <div class="copy-section">
        <div class="container">
            <div class="footer-top">
                <p>� 2017 Personal Resume. All rights reserved | Design by <a href="nibuthomas.surge.sh">Nibu Thomas</a></p>
            </div>
        </div>
    </div>
    <!-- copyright-ends-here -->
